    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((item) => (
          <div
            key={item.name}
            className="relative bg-white p-5 rounded-lg overflow-hidden shadow hover:shadow-md transition-shadow duration-300"
          >
            <dt>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          ...
          <div className="h-60 sm:h-80 flex items-center justify-center border-2 border-dashed border-gray-200 rounded-lg">
                      ...
                      <div className="min-w-0 flex-1 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">
                            New tenant signed lease for{' '}
                            <span className="font-medium text-gray-900">Unit 204</span>
                          </p>
                        </div>
