...
import 'package:tranquilestate_admin_panel/features/dashboard/screen/dashboard/dashboard.dart';
...
class TAppRoute {
  static final List<GetPage> pages = [
    ...
    GetPage(name: TRoutes.dashboard, page: () => const DashboardScreen(), middlewares: [TRouteMiddleare()]),
  ];
}
